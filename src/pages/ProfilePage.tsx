...
import { ShoppingBag, Heart, Package, Truck, CheckCircle2, Clock, MapPin, ChevronRight, LogOut, User as UserIcon } from 'lucide-react';
          ...
          <aside className="w-full lg:w-72 shrink-0">
            <div className="space-y-6 sticky top-36">
               {[
                 ...
                 { id: 'wishlist', label: 'Curated Wishlist', icon: <Heart className="w-4 h-4" /> }
               ].map((tab) => (
                 <button 
                   key={tab.id}
             ...
             {activeTab === 'orders' ? (
               ...
               <div className="space-y-12">
                  ...
                  {wishlistProducts.length > 0 ? (
                    ...
                    <div className="py-40 text-center flex flex-col items-center justify-center">
                       <Heart className="w-20 h-20 text-gray-100 mb-8" />
