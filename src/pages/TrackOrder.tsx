...
export default function TrackOrder() {
  ...
  const getStatusStep = (status: string, paymentStatus?: string) => {
    ...
    if (paymentStatus === 'confirmed' || status === 'processing') return 2;
    return 1; // pending
  };
    ...
    <div className="min-h-screen bg-[#fdfbf7] flex flex-col items-center pt-20 px-4 pb-20 selection:bg-black selection:text-white">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <p className="text-gray-400 text-sm font-medium mb-6">Enter your Order ID to check the current status of your purchase.</p>
        ...
        <AnimatePresence>
          {order && (
            ...
            >
              {/* Large Status Card */}
              <div className="bg-[#2a2a2a] text-white p-8 md:p-20 shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-12 relative z-10">
                  <div>
                    <span className="text-[8px] sm:text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 block mb-3 sm:mb-6">STATUS OF ORDER</span>
                  ...
                  <div className="text-left md:text-right">
                    ...
                    <h2 className="text-2xl sm:text-4xl md:text-5xl font-serif italic">5-7 Business Days</h2>
                  </div>
                </div>
              </div>
              ...
              <div className="relative py-8 md:py-12 px-2">
                ...
                <div 
                  className="absolute top-[calc(48px+1.5rem)] left-10 h-[1px] bg-[#8B735B] transition-all duration-1000 hidden md:block" 
                    ...
                    return (
                      <div key={idx} className="flex flex-col items-center group relative">
                        ...
                        <div className="mt-4 md:mt-8 text-center px-1">
                          ...
                          <p className="text-[7px] md:text-[8px] font-bold text-gray-300 uppercase tracking-widest hidden sm:block">
                            {step.sub}
                          </p>
                        </div>
              ...
              <div className="fixed bottom-10 right-10 z-50">
                <a 
                  href={`https://wa.me/919345275150?text=Hi, I am tracking my order TC-${order.id.slice(0,8)}. Can you provide update?`}
                  target="_blank"
