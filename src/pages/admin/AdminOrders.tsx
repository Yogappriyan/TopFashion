              ...
              >
                ...
                <div className="px-10 py-10 border-b border-black/[0.03] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold tracking-tight mb-1 uppercase">TC-{order.id.slice(0, 15).toUpperCase()}</h3>
                    <div className="flex flex-wrap items-center gap-3 text-[10px] font-bold text-gray-300 uppercase tracking-widest">
